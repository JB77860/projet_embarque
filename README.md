...
1. Effectuer tous les branchements nécessaires sur la carte Raspberry Pi 3 : le capteur de présence ainsi que les 3 LED vert, orange, rouge 
  ...
  &emspBroche GPIO 20 : Utilisée comme entrée pour la capteur de mouvement  
  &emspBroches GPIO 13, 29, 26 : Utilisées comme sorties pour les LED 
...
2. Télécharger un OS : et le mettre sur une carte SD pour pouvoir l'installer sur la carte Raspberry Pi 3
  ...
  &emspRaspberry Pi OS Lite  
  &emspRelease date: May 3rd 2023  
  &emspSystem: 32-bit  
  &emspKernel version: 6.1  
  &emspDebian version: 11 (bullseye)  
  &emspize: 364MB  
...
3. Mettre l'OS choisi sur une carte SD pour pouvoir l'installer sur la carte Raspberry Pi 3
  ...
  &emspNous avons fait le choix de passer par raspeberry pi imager très facile d'utilisation
